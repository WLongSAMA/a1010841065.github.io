					...
					start: {
						...
						buttons: {
							'facebook': {
								...
								nextScene: 'end',
								onChoose: function() {
									window.open('https://www.facebook.com/sharer/sharer.php?u=' + Engine.SITE_URL, '_self');
								}
							},
							'google': {
								text:_('google+'),
								nextScene: 'end',
								onChoose: function() {
									window.open('https://plus.google.com/share?url=' + Engine.SITE_URL, '_self');
								}
							},
							'twitter': {
								text: _('twitter'),
								onChoose: function() {
									window.open('https://twitter.com/intent/tweet?text=A%20Dark%20Room&url=' + Engine.SITE_URL, '_self');
								},
								nextScene: 'end'
							},
							'reddit': {
								text: _('reddit'),
								onChoose: function() {
									window.open('http://www.reddit.com/submit?url=' + Engine.SITE_URL, '_self');
								},
								nextScene: 'end'
							},
							'close': {
