$(document).ready(function () {
    ...
    $(".main .ss-content li").click(function () {
        $(".ss-header li").removeClass("actived");
        $(".ss-container .ss-content").removeClass("actived");
        if ($(this).parent().parent().index() == 0) {
            ...
            if ($(this).index() == 0) {
                ...
                $("html,body").animate({scrollTop:$("#" + $(this).attr("data") + ($(this).index() + 1)).offset().top - 80}, 100);
            }
        } else {
...
function ShuChuTanSuo() {
    ...
    for (i = 0; i < tansuoData.length; i++) {
        strTanSuo = strTanSuo + '<div id="ts' + (i + 1) + '" class="title1">' + tansuoData[i].title + "</div>";
...
function ShuChuYuHun() {
    ...
    for (i = 0; i < yuhunData.length; i++) {
        strYuHun = strYuHun + '<div id="yh' + (i + 1) + '" class="title1">' + yuhunData[i].title + "</div>";
...
function ShuChuMiWen() {
    ...
    for (i = 0; i < miwenData.length; i++) {
        strMiWen = strMiWen + '<div id="mw' + (i + 1) + '" class="title1">' + miwenData[i].title + "</div>";
